  ...
  function installAgentCommerceSection() {
    ...
    if (!document.getElementById('agentCommerceStyles')) {
      ...
      style.textContent = [
        ...
        '.agent-commerce-heading h2{max-width:840px;margin:0;padding:.05em 0 .10em;color:#fff;font-size:clamp(42px,4.35vw,68px);font-weight:900;line-height:1.045;letter-spacing:-.055em}.agent-commerce-heading h2 em{display:inline-block;padding-bottom:.07em;font-style:normal;background:linear-gradient(90deg,#ff8735,#ff3f7f,#bd3cff,#4b9fff);-webkit-background-clip:text;background-clip:text;color:transparent}',
        '.agent-commerce-heading p{max-width:760px;margin:18px 0 0;color:#b4bfce;font-size:17px;line-height:1.72}',
