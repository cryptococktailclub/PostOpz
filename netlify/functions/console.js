...
function slackPage(slack, requestToken) {
  const intro = '<section class="page-heading"><p class="eyebrow">Slack · Channel workspace</p><h1>Team activity</h1><p>Browse selected public Slack channels inside Console. Message text is fetched live for this screen and is not copied into the Console database.</p></section>';
