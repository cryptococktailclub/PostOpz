...
function responsePage(body, headers = {}) {
  ...
  const pairingRecoveryStyles = '<style>.notice{white-space:pre-wrap}.source-row-actions{display:grid;justify-items:end;gap:4px}.source-row-actions form,.pairing-actions form{margin:0}.pairing-actions{display:flex;gap:12px;align-items:center}.production-slack-feed{max-height:410px;overflow-y:auto;padding-right:10px;scrollbar-color:rgba(55,217,255,.55) transparent;scrollbar-width:thin}.production-slack-feed::-webkit-scrollbar{width:7px}.production-slack-feed::-webkit-scrollbar-thumb{border-radius:99px;background:rgba(55,217,255,.5)}</style>';
