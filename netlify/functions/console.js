...
function responsePage(body, headers = {}) {
  ...
  const brandedBody = String(body)
    ...
    .replace('</body>', '<script src="/assets/console-live.js" defer></script></body>');
