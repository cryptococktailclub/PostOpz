...
async function registerIntegration(config, accessToken, dashboard, form) {
  ...
  const providers = ['iconik', 'google_drive', 'frame_io', 'masv', 'slack', 'aws_s3', 'backblaze_b2', 'wasabi'];
